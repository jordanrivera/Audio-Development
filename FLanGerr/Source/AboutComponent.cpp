...
AboutComponent::AboutComponent ()
{
    ...
    githubLink.reset (new HyperlinkButton (TRANS("https://www.audiopluginshop.com"),URL ("http://www.audiopluginshop.com")));
    ...
    versionLabel.reset ( new Label ("versionLabel",TRANS("Version:")));
